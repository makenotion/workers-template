...
readonly CANONICAL_ALPHA_INSTRUCTIONS="$TEMPLATE_ROOT/.agents/INSTRUCTIONS.alpha.md"
readonly CANONICAL_SKILLS="$TEMPLATE_ROOT/.agents/skills"
readonly AGENTS_INSTRUCTIONS="$TEMPLATE_ROOT/AGENTS.md"
readonly AGENTS_ALPHA_INSTRUCTIONS="$TEMPLATE_ROOT/AGENTS.alpha.md"
readonly CLAUDE_INSTRUCTIONS="$TEMPLATE_ROOT/CLAUDE.md"
readonly CLAUDE_ALPHA_INSTRUCTIONS="$TEMPLATE_ROOT/CLAUDE.alpha.md"
...
check_copies() {
	...
	check_file_copy "$CANONICAL_ALPHA_INSTRUCTIONS" "$AGENTS_ALPHA_INSTRUCTIONS" || status=1
	check_file_copy "$CANONICAL_INSTRUCTIONS" "$CLAUDE_INSTRUCTIONS" || status=1
	check_file_copy "$CANONICAL_ALPHA_INSTRUCTIONS" "$CLAUDE_ALPHA_INSTRUCTIONS" || status=1
...
sync_copies() {
	...
	cp "$CANONICAL_ALPHA_INSTRUCTIONS" "$AGENTS_ALPHA_INSTRUCTIONS"
	cp "$CANONICAL_INSTRUCTIONS" "$CLAUDE_INSTRUCTIONS"
	cp "$CANONICAL_ALPHA_INSTRUCTIONS" "$CLAUDE_ALPHA_INSTRUCTIONS"
	rm -rf "$CLAUDE_SKILLS"
